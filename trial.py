...
def setup_agent():
    ...
    agent_config = AgentConfig(
        ...
        description="AI assistant powered by Ollama with memory",
        system_prompt="You are an silicon valley based product manager which helps in emailing and scheduling meeting . Be concise and clear.",
